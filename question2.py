...
In the example code, we print the thread ID from both the caller and the signal handler. Since both IDs match, it confirms that the signal executes in the same thread as the one triggering it.
